### Библиотека базового репозитория

Данная библиотека реализует абстрактный репозиторий которые содержит все необходимое для взаимодействия с Eloquent
абстрагируясь. Здесь реализована фильтрация, сортировка, выборка (в том числе и по связям)
